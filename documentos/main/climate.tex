...
Esses dados destacam o papel intensificado das atividades humanas no agravamento do efeito estufa, incluindo a queima de
combustíveis fósseis, desmatamento e emissões industriais. A escala e a velocidade dessas emissões não apenas evidenciam
os impactos profundos das ações humanas sobre o clima, mas também reforçam a necessidade urgente de iniciativas
coordenadas em escala global para mitigar os danos climáticos e garantir um futuro mais sustentável. Ações como o Acordo
de Paris são essenciais para garantir a coordenação das ações climáticas ao estabelecer metas e responsabilidades de
cada nação. Firmado em 2015 pelas nações participantes do Convenção-Quadro das Nações Unidas sobre a Mudança do Clima
(UNFCCC), o acordo estabelece a necessidade de reduzir as emissões de GEEs em escala global, visando manter o aumento de
temperatura abaixo de 2ºC em relação à base pré-industrial, além de providenciar mecanismos para que nações em
desenvolvimento possam mitigar os efeitos das mudanças climáticas e se adaptar a elas sem comprometer severamente suas
atividades econômicas.

\subsection{Aumento de precipitação e enchentes}
"slow-onset shifts and extreme events". Talvez dar uma definição da diferença entre os dois me dê espaço para abrir o
segundo. Algo como "Mudanças em média de temperatura são mudanças graduais que levam à eventos climáticos extremos
(pontuais)";

Além do aumento de temperaturas em si, outro evento que vem aumentando de frequência e intensidade são as ondas de calor
e precipitação.

% Um dos efeitos mais evidentes do aumento dos GEEs é o impacto direto nos padrões climáticos globais, incluindo o
% crescimento das taxas de precipitação e a intensificação de eventos extremos, como enchentes. Com o aquecimento global,
% a atmosfera é capaz de reter mais vapor de água, o que resulta em chuvas mais intensas e imprevisíveis. Esse cenário
% afeta diretamente as regiões vulneráveis, especialmente aquelas onde a infraestrutura de drenagem e controle de
% enchentes é insuficiente, agravando os danos econômicos e sociais. Assim, além de reduzir as emissões, os esforços
% globais também precisam priorizar ações de adaptação, como o desenvolvimento de infraestruturas resilientes, a
% implementação de sistemas de alerta precoce e a gestão sustentável de recursos hídricos.
