...
\begin{figure}[htb]
	\caption{\label{bacia_guaiba} Mapa da Bacia Hidrográfica do Guaíba}
	\begin{center}
...
conforme padronização do IBGE em seus mapas oficiais \cite{ibgeguai}. Essa decisão é baseada na maior disponibilidade
de literatura relacionada à cheias fluvias e a utilização de fontes de dados provenientes do IBGE. Contudo, quando
...
% Sistema dendritico através do estado
