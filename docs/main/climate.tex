...
água ocorre devido à dificuldade de escoamento, seja pela incapacidade do solo de absorvê-la ou pela lentidão na
...
intensas no corpo principal ou em seus tributários que provoca o transbordamento de grandes corpos d'água. Se o corpo
hídrico tiver capacidade de escoar a água de forma eficiente, o alagamento pode ser evitado. Muitos corpos d'água, cuja
principal fonte de abastecimento são enchentes pluviais, possuem uma morfologia adaptada para lidar com essa condição.
Outros fatores que contribuem para o transbordamento incluem a área de escoamento disponível em canais naturais e
artificiais, a umidade prévia do solo, sua capacidade de percolação, a presença de ventos fortes e sua interação com o
fluxo da água, a taxa de evaporação após o evento, a capacidade de absorção da vegetação local, o declive do terreno em
relação à área de escoamento, entre outros. Assim, não se pode associar exclusivamente o aumento das chuvas intensas
(\autoref{rain}) ao crescimento de todos os eventos extremos desse tipo (REFERÊNCIA).

Mesmo assim, enchentes são um fenômeno natural e muitas vezes característicos de certas regiões. Áreas com invernos
rigorosos, marcados pela acumulação de neve, frequentemente enfrentam enchentes durante o verão, quando o rápido
derretimento do gelo transporta grandes volumes de água de uma região para outra, suportando ecosistemas que dependem
desse influxo de água sazonal. Regiões com fortes Monções, ventos sazonais que trazem para o interior um acumulo de
umidade e precipitação maritima, também são caracterizadas por cheias em seus corpos d'água, essenciais para agricultura
nas regiões, como nos tributários do Rio Ganges e Rio Amarelo. Da mesma forma, as cheias anuais precisas do Rio Nilo
foram, desde a antiguidade, fundamentais para a fertilidade da região. 
...
precipitação marítima — também são marcadas por cheias em seus corpos d'água, fundamentais para a agricultura local,
como ocorre nos tributários dos rios Ganges e Amarelo. De maneira semelhante, as cheias anuais regulares do Rio Nilo são
...
As mudanças climáticas tem um efeito direto nos aumentos de enchentes. Embora não sejam o único fator responsável por
enchentes, um aumento de chuva e, em especial, chuvas intensas, tem uma relação direta com o aumento e intensidade das
mesmas, além das áreas afetadas. De acordo com Seneviratne et al. (2021) no capítulo 11.1 do sexto relatório, segundo
grupo, do IPCC (AR6 WGII): 

\begin{citacao}
As mudanças climáticas já estão alterando a localização, frequência e gravidade das inundações. Os eventos de chuvas
fortes e prolongadas responsáveis pela maioria das inundações estão se tornando mais intensos em muitas áreas à medida
que o clima esquenta dado que o ar próximo à superfície da Terra pode transportar mais água (...). Essa umidade extra é
atraída para os sistemas climáticos, alimentando chuvas mais pesadas. Um clima mais quente também afeta os padrões de
vento, como as tempestades se formam e evoluem, e o caminho que essas tempestades geralmente viajam. O aquecimento
também aumenta as taxas de condensação, o que por sua vez libera calor extra que pode energizar os sistemas de
tempestades e intensificar ainda mais as chuvas. Por outro lado, essa liberação de energia também pode inibir a elevação
necessária para o desenvolvimento das nuvens, enquanto o aumento na poluição por partículas pode atrasar as chuvas, mas
revigorar as tempestades. Essas mudanças significam que o caráter dos eventos de precipitação (com que frequência,
quanto tempo duram e quão pesados eles são) continuará a mudar à medida que o clima esquenta.

Além das mudanças climáticas, a localização, frequência e momento dos eventos de chuva mais pesados e piores inundações
dependem de flutuações naturais nos padrões de vento que tornam algumas regiões anormalmente úmidas ou secas por meses,
anos ou até mesmo décadas. Essas variações naturais dificultam determinar se eventos de chuvas pesadas estão mudando
localmente como resultado do aquecimento global. No entanto, quando os padrões climáticos naturais trazem chuvas pesadas
e prolongadas em um clima mais quente, a intensidade é aumentada pela maior quantidade de umidade no ar. Uma intensidade
e frequência aumentadas de chuvas diárias recordes foram detectadas em grande parte da superfície terrestre onde existem
bons registros observacionais, e isso só pode ser explicado por aumentos causados pelo homem nas concentrações
atmosféricas de gases de efeito estufa. Chuvas pesadas também são projetadas para se tornarem mais intensas no futuro
para a maioria dos lugares.

\textit{Seneviratne et al. (2021)\cite{ipcc_ar6_wg2_chap11}, traduzido pelo autor.}
\end{citacao}

% Tendência de Enchentes;
Na América Latina, ...
