...
adaptar a elas sem comprometer severamente suas atividades econômicas.
...
a existência de grandes corpos d'água que podem ser, dadas circunstâncias, vulneráveis à enchentes. As mesmas podem
invadir esses locais, muitas vezes de forma inesperada e veloz, ameaçando as vidas e segurança desses indivíduos e
causando danos estruturais que levam à mais disrupção em atividades humanas. Fatalidades causadas por afogamentos são
comuns em regiões alagadas, devido à não somente o quão rápido os mesmos ocorrem, mas também à características do
escoamento dessas águas que causam correntes fortes e inesperadas. Além disso, as condições que as enchentes criam são
perfeitas para o agravamento de outras condições sanitárias, tanto de forma direta como natransmissão de doenças através
da água, quanto indiretamente por afetar sistemas críticos como cotaminação de fontes des água potável, disrupção de
energia elétrica, afetando hospitais e serviços essenciais e destruição de linhas de suprimento, que podem insolar
comunidades, mesmo que não afetadas diretamente pelas enchentes, de mantimentos.

Contudo, mesmo sendo uma parte integral do ciclo da água, a proximidade de assentamentos humanos com grandes corpos
d'água frequentemente os expõe à vulnerabilidade frente às enchentes. Essas inundações podem invadir esses locais de
maneira inesperada e veloz, colocando vidas em risco, comprometendo a segurança das comunidades e causando danos
estruturais que amplificam a disrupção das atividades humanas. Fatalidades por afogamento são comuns em regiões
alagadas, não apenas pela rapidez com que as enchentes ocorrem, mas também devido às características do escoamento das
águas, que podem gerar correntes fortes e imprevisíveis.

Além disso, as enchentes criam condições propícias para o agravamento de problemas sanitários. Elas podem transmitir
doenças por meio da água contaminada, além de comprometer sistemas críticos, como a contaminação de fontes de água
potável, a interrupção do fornecimento de energia elétrica, afetando hospitais e serviços essenciais, e a destruição de
cadeias de suprimentos. Esses fatores podem isolar comunidades inteiras, mesmo aquelas não diretamente afetadas pela
inundação, dificultando o acesso a mantimentos e recursos básicos.
