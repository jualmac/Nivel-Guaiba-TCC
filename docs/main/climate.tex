...
evidenciada através das Anomalias de Temperatura. Definidas como a diferença entre a temperatura observada em um
...
econômicas essenciais. (EXPANDIR E MELHOR CONECTAR COM OS CAPITULOS A SEGUIR).
...
desastres naturais causados pelo aumento climático. (EXPANDIR)
