...
\begin{figure}[htb]
	\caption{\label{contrib} Contribuições}
	\begin{center}
	    \includegraphics[scale=0.5]{img/HIstorical cumulative emissions by region.png}
	\end{center}
	\legend{Fonte: }
\end{figure}
...
\begin{figure}[htb] 
	...
	\begin{center}
	    \includegraphics[scale=0.35]{img/trend_precipitation.png}
	\end{center}
	\legend{Fonte: }
\end{figure}
