...
redução de temperaturas mínimas e ondas de calor\footnote{Definido por Dunn et al. (2024) \cite{dunn} como 3 ou
...
Além disso, é importante notar que o aumento das temperaturas não apenas está associado a um incremento na precipitação
total, mas também está ligado à intensificação dos extremos de precipitação. Observa-se não só um aumento no volume
máximo de chuva em um único dia, evidenciando a maior intensidade dos eventos, como também no acumulado de precipitação
em períodos de cinco dias, indicando uma maior duração desses extremos \cite{dunn}.
...
século XX \cite{dunn}, e, acompanhado das mesmas, uma intensificação em enchentes e deslizamentos, que são a maior causa de morte
