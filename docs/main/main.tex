...
América Latina. Será também explorado a vulnerabilidade intrinseca de centros urbanos e a necessidade elevada de
prevenção e monitoramento para tais situações.
    \section{Mudanças climáticas e desastres naturais}
    \input{climate.tex}
    \section{Enchente de 2024 na Região Metropolitana de Porto Alegre}
    \input{flood.tex}
