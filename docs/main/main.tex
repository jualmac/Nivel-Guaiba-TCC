...
dados foram pré-processados com interpolação de falhas e normalização, e os modelos otimizados via optimização
...
% O estudo indicou que o LightGBM obteve o melhor equilíbrio entre acurácia (RMSE = 8,3 cm; NSE = 0,96) e
